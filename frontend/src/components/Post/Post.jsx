...
const samplePost = {
  ...
  timestamp: "2h ago",
  content:
    "Just finished presenting our new product roadmap at #ProductCon! Excited about the innovative features we're launching next quarter. Thanks to @SarahT and the amazing design team for the collaboration.\n\nWhat emerging tech trends are you most excited about for 2025? #ProductManagement #Innovation #TechTrends",
  media: [
    {
      type: "image",
...
export const Post = ({ Post }) => {
  ...
  return (
    <>
      <Card className="w-[600px] dark:bg-[#121013] max-w-screen m-auto mb-8 mx-0 overflow-hidden border-social-gray-light shadow-sm hover:shadow-md transition-shadow">
